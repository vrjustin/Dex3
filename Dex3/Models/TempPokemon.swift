...
struct TempPokemon: Codable {
    ...
    enum PokemonKeys: String, CodingKey {
        ...
        enum StatDictionayKeys: String, CodingKey {
    ...
    init(from decoder: any Decoder) throws {
        ...
        while !statsContainer.isAtEnd {
            let statsDictionaryContainer = try statsContainer.nestedContainer(keyedBy: PokemonKeys.StatDictionayKeys.self)
            let statContainer = try statsDictionaryContainer.nestedContainer(keyedBy: PokemonKeys.StatDictionayKeys.StatKeys.self, forKey: .stat)
